...
オプション一覧: 
1. -a<br />
   --all         : RDBMS からドメイン名の一覧を取得して、そのすべてに DS レコードを設定します。引数にドメイン名を指定しても無視されます。<br />
2. -c<br />
   --use-csk     : KSK と ZSK の代わりに、CSK を生成します。(ディフォルトです)<br />
3. -s<br />
   --separate-key: CSK ではなく、KSK と ZSK をそれぞれ生成します。<br />
4. -z<br />
   --only-zsk    : ZSK だけを更新します。<br />
